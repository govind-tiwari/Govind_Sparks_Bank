...
<div class="header">
	<div class="mainHeader">
  		<nav>
			...
			<a href="moneytranc.php" class="active">Money Transaction</a>
		</nav>
		<div class="menubtn">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    <tr class="table-light">
                        ...
                        <td>
                            <p id=" NitishBankBalance">18500000</p>
                        </td>
                    </tr>
                     <tr class="table-info">
                        <td scope="row">2</td>
                        ...
                        <td>
                            <p id="GautamBankBalance">160656000</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td scope="row">3</td>
                        ...
                        <td>
                            <p id="PrinceBankBalance">12500000</p>
                        </td>
                    </tr>
                    <tr class="table-info">
                        <td scope="row">4</td>
                        ...
                        <td>raj@gmail.com</td>
                        <td>
                            <p id="RajBankBalance">34000300</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td scope="row">5</td>
                        ...
                        <td>
                            <p id="PrinshuBankBalance">607023000</p>
                        </td>
                    </tr>
                    <tr class="table-info">
                        <td scope="row">6</td>
                        ...
                        <td>
                            <p id="AdarshBankBalance">45090400</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td>7</td>
                        ...
                        <td>
                            <p id="TarakantBankBalance">98008800</p>
                        </td>
                    </tr>
                    <tr class="table-info">
                        <td scope="row">8</td>
                        ...
                        <td>
                            <p id="AniketBankBalance">11063700</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td>9</td>
                        ...
                        <td>
                            <p id="SwettyBankBalance">10034500</p>
                        </td>
                        </tr>
                        <tr class="table-info">
                            <td>10</td>
                            ...
                            <td>
                                <p id="PriyankaBankBalance">20003400</p>
                            </td>
                        </tr>
                        <td>Rohit</td>
		                    <td>rohit@gmail.com</td>
                            <td>
                                <p id="RohitBankBalance">30007800</p>
                            </td>
                        </tr>
